...
const Project = ({ project }) => {
  ...
  return (
    <div className='lg:w-1/4 z-20 h-fit pb-4 w-10/12 bg-[#1c1b1bee] sm:w-[45%] border-2 rounded-xl border-gray-700 mx-auto text-center'>
      ...
      <div className="w-5/6 m-auto">
        ...
        <div className="flex flex-wrap justify-center gap-2 my-4">
          {skills.map((skill, id) => (
            <p key={id} className='p-[2px] bg-[#88218f] text-[10px] text-left'>{skill.skill}</p>
          ))}
        </div>
